...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        <!-- Dashboard -->
        <li class="menu-item {{ $is('dashboard.index') ? 'active' : '' }}">
        ...
        <li class="menu-item {{ $isGroup('account-settings') ? 'active open' : '' }}">
            ...
            <ul class="menu-sub">
                <li class="menu-item {{ $is('account-settings.account') ? 'active' : '' }}">
                    <a href="{{ route('account-settings.account') }}" class="menu-link">
                        <div data-i18n="Account">Account</div>
                    </a>
                </li>
                <li class="menu-item {{ $is('account-settings.notifications') ? 'active' : '' }}">
                    <a href="{{ route('account-settings.notifications') }}" class="menu-link">
                        <div data-i18n="Notifications">Notifications</div>
                    </a>
                </li>
                <li class="menu-item {{ $is('account-settings.connections') ? 'active' : '' }}">
        ...
        {{-- <li
            ...
            <ul class="menu-sub">
                <li class="menu-item {{ $is('forms.basic-inputs') ? 'active' : '' }}">
                    <a href="{{ route('forms.basic-inputs') }}" class="menu-link">
                        <div data-i18n="Basic Inputs">Basic Inputs</div>
                    </a>
                </li>
                <li class="menu-item {{ $is('forms.input-groups') ? 'active' : '' }}">
        ...
        {{-- <li
            ...
            <ul class="menu-sub">
                <li class="menu-item {{ $is('forms.layouts-vertical') ? 'active' : '' }}">
                    <a href="{{ route('forms.layouts-vertical') }}" class="menu-link">
                        <div data-i18n="Vertical Form">Vertical Form</div>
                    </a>
                </li>
                <li class="menu-item {{ $is('forms.layouts-horizontal') ? 'active' : '' }}">
                    <a href="{{ route('forms.layouts-horizontal') }}" class="menu-link">
